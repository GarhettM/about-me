...
// We have a function called cities
// You only have 3 attempts
// The Question is 'How many cities have I lived in during my childhold?'
// The answer to is the quanitity 5.
// Counter
...
//   var answer = 5;
//   var attempts = 0;
//   var question = prompt('How many cities?');
//   var userInput;
//   while (question !== answer && attempts < 3) {
//   }
// }

function cities() {
  var attemptsMade = 0;
  var sixthQ = parseInt(prompt('How many cities have I lived in during my childhold?'));
  var alertSix;
  while(attemptsMade < 2 && sixthQ !== 5){
    alertSix = prompt('Ya dun goofed Try again!');
    attemptsMade++;
  }
  if (attemptsMade === 2){
    confirm('You\'re a fool, please proceed to the next question or face an infinite loop!');
  } else {
    confirm('Congrats, you cared enough');
  }
